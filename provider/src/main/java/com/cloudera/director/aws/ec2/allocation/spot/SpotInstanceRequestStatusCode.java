...
public enum SpotInstanceRequestStatusCode {
  ...
  /**
   * Indicates that a Spot instance request has not been fulfilled because the request Spot price is
   ...
   * Spot price is high enough, but the corresponding instance has not yet been provisioned.
   */
   ...
   * the EC2 Spot price rose above the request's Spot price.
   */
  ...
  private static final Logger LOG = LoggerFactory.getLogger(SpotInstanceRequestStatusCode.class);
