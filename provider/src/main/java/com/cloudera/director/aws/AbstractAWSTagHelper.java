...
public abstract class AbstractAWSTagHelper<T> {
   ...
   *
   * @param virtualInstanceId the virtual instance ID as generated by Cloudera Altus Director
  ...
  /**
   * Creates a tag for recording the Cloudera Altus Director template name.
   *
   * @param templateName the Cloudera Altus Director template name
   * @return a tag for recording the Cloudera Altus Director template name
   */
