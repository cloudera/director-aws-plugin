...
import static com.cloudera.director.aws.rds.RDSProviderConfigurationPropertyToken.REGION;
import static com.cloudera.director.aws.rds.RDSProviderConfigurationPropertyToken.REGION_ENDPOINT;
      ...
      if (regionEndpoint != null) {
        ...
        if (region == null) {
          region = configuration.getConfigurationValue(
              EC2ProviderConfigurationPropertyToken.REGION,
