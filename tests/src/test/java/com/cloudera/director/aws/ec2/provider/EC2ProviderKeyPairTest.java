...
public class EC2ProviderKeyPairTest {
  ...
  public void testEnhanceTemplateConfigurationWithBothKeysPresentMatchingPublicKey() throws Exception {
    ...
    when(ec2Client.describeKeyPairs(any(DescribeKeyPairsRequest.class))).thenReturn(result);
  ...
  @Test
  public void toColonSeparatedHexStringTest() {
    String nonColonSeparated = "7f6336ab2bfgaf203937ac6ab8a84012";
    String colonSeparated = "7f:63:36:ab:2b:fg:af:20:39:37:ac:6a:b8:a8:40:12";
    assertThat(EC2Provider.toColonSeparatedString(nonColonSeparated)).isEqualTo(colonSeparated);
  }
}
