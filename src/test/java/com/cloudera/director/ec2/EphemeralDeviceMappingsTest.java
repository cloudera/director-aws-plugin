...
public class EphemeralDeviceMappingsTest {
  ...
  private final Map<String, String> configurationMap = ImmutableMap.<String, String>builder()
      .put(CUSTOM_MAPPINGS_PATH.unwrap().getConfigKey(),
          "./src/test/resources/com/cloudera/director/ec2/customephemeraldevicemappings.properties")
      .build();

  private final EphemeralDeviceMappings ephemeralDeviceMappings =
      new EphemeralDeviceMappings(new SimpleConfiguration(configurationMap),
