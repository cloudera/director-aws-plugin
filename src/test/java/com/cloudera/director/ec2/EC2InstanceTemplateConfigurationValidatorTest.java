...
import static com.cloudera.director.ec2.EC2InstanceTemplate.EC2InstanceTemplateConfigurationPropertyToken;
...
import static com.cloudera.director.ec2.EC2InstanceTemplateConfigurationValidator.HVM_VIRTUALIZATION;
import static com.cloudera.director.ec2.EC2InstanceTemplateConfigurationValidator.INVALID_AMI_ARCHITECTURE_MSG;
import static com.cloudera.director.ec2.EC2InstanceTemplateConfigurationValidator.INVALID_AMI_INSTANCE_TYPE_COMPATIBILITY_MSG;
import static com.cloudera.director.ec2.EC2InstanceTemplateConfigurationValidator.INVALID_AMI_NAME_MSG;
import static com.cloudera.director.ec2.EC2InstanceTemplateConfigurationValidator.INVALID_AMI_PLATFORM_MSG;
import static com.cloudera.director.ec2.EC2InstanceTemplateConfigurationValidator.INVALID_AMI_ROOT_DEVICE_TYPE_MSG;
import static com.cloudera.director.ec2.EC2InstanceTemplateConfigurationValidator.INVALID_IAM_PROFILE_NAME_MSG;
import static com.cloudera.director.ec2.EC2InstanceTemplateConfigurationValidator.MIN_ROOT_VOLUME_SIZE_GB;
import static com.cloudera.director.ec2.EC2InstanceTemplateConfigurationValidator.PARAVIRTUAL_VIRTUALIZATION;
import static com.cloudera.director.ec2.EC2InstanceTemplateConfigurationValidator.ROOT_VOLUME_TYPES;
...
public class EC2InstanceTemplateConfigurationValidatorTest {
   ...
   */
  private void verifySingleError(EC2InstanceTemplateConfigurationPropertyToken token) {
