...
import static com.cloudera.director.ec2.EphemeralDeviceMappings.EphemeralDeviceMappingsConfigProperties.EphemeralDeviceMappingsConfigurationPropertyToken.CUSTOM_MAPPINGS_PATH;
import static com.cloudera.director.ec2.EphemeralDeviceMappings.EphemeralDeviceMappingsConfigProperties.EphemeralDeviceMappingsConfigurationPropertyToken.DEVICE_NAME_PREFIX;
import static com.cloudera.director.ec2.EphemeralDeviceMappings.EphemeralDeviceMappingsConfigProperties.EphemeralDeviceMappingsConfigurationPropertyToken.RANGE_START;
import static com.google.common.base.Preconditions.checkArgument;
import static com.google.common.base.Preconditions.checkNotNull;

import com.amazonaws.services.ec2.model.BlockDeviceMapping;
import com.cloudera.director.common.PropertyResolvers;
...
public class EphemeralDeviceMappings implements Function<String, List<BlockDeviceMapping>> {
  ...
  public static class EphemeralDeviceMappingsConfigProperties {
    ...
    public static enum EphemeralDeviceMappingsConfigurationPropertyToken
      ...
      /**
       * Relative configuration path for finding custom device mappings.
       */
      CUSTOM_MAPPINGS_PATH(new SimpleConfigurationPropertyBuilder()
          .configKey("customMappingsPath")
          .name("Custom mappings path")
          .defaultDescription("The relative configuration path for finding custom device mappings.")
          .build());
    ...
    public static final String DEFAULT_CUSTOM_MAPPINGS_PATH =
        "./etc/ec2.ephemeraldevicemappings.properties";
    ...
    public void setDeviceNamePrefix(String deviceNamePrefix) {
      if (deviceNamePrefix != null) {
        LOG.info("Overriding deviceNamePrefix={} (default {})",
    ...
    public void setRangeStart(String rangeStart) {
      if (rangeStart != null) {
        ...
        LOG.info("Overriding rangeStart={} (default {})",
            c, DEFAULT_RANGE_START_FOR_EPHEMERAL_DRIVES);
        this.rangeStart = c;
      }
    }
    ...
    public void setCustomMappingsPath(String customMappingsPath) {
      if (customMappingsPath != null) {
        ...
        checkArgument(new File(customMappingsPath).exists(),
  ...
  public static class EphemeralDeviceMappingsConfig {
    ...
    public static final String BUILT_IN_LOCATION =
        "classpath:/com/cloudera/director/ec2/ephemeraldevicemappings.properties";
  ...
  /**
   * Creates ephemeral device mappings.
   *
   * @param launcherLocalizationContext the the parent launcher localization context
   */
  public EphemeralDeviceMappings(LocalizationContext launcherLocalizationContext) {
    this(new EphemeralDeviceMappingsConfigProperties(new SimpleConfiguration(),
   ...
   */
  public EphemeralDeviceMappings(Configured configuration,
      LocalizationContext launcherLocalizationContext) {
    this(new EphemeralDeviceMappingsConfigProperties(configuration, launcherLocalizationContext));
  }
  ...
  public List<BlockDeviceMapping> apply(String instanceType) {
    ...
    if (!optCount.isPresent()) {
      LOG.error("Unsupported instance type {}, add its ephemeral instance " +
              "volume count as a custom mapping; assuming zero",
          instanceType);
