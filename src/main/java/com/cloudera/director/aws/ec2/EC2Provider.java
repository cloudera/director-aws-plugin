...
public class EC2Provider extends AbstractComputeProvider<EC2Instance, EC2InstanceTemplate> {
  ...
  public static enum EC2ProviderConfigurationPropertyToken
    ...
    IAM_ENDPOINT(new SimpleConfigurationPropertyBuilder()
        ...
        .name("IAM endpoint")
        .defaultDescription("The IAM endpoint.")
        .build()),
  ...
  public EC2Provider(Configured configuration,
    ...
    String iamEndpoint = getConfigurationValue(IAM_ENDPOINT, localizationContext);
    if (iamEndpoint != null) {
      LOG.info("<< Using configured IAM endpoint: {}", iamEndpoint);
      this.identityManagementClient.setEndpoint(iamEndpoint);
    }
